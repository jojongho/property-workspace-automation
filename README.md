...
- `apps-script/apartment-entry-automation/entry-form.js`
- `apps-script/apartment-entry-automation/price-helper.js`
...
- `make check`
- `python3 scripts/gws_create_apps_script_project.py --title <TITLE> --parent-id <SPREADSHEET_ID>`
